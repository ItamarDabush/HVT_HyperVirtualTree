    ...
    def _forward_impl(self, x: Tensor, binarize = None) -> Tensor:
        ...
        for i, layer in enumerate(self.layer2):
            if isinstance(layer, WideHyperBasicBlock):
                ...
                x1 = layer(x1)
        x = x0 + x1
        sigmas_r_2, sigmas_b_2 = self.binary_selection_layer2(x, binarize)
...
if __name__ == '__main__':
    ...
    wresnet = WideResNet_HyperDecisioNet(28, 10, dropout_p=0.3, num_classes=10)
