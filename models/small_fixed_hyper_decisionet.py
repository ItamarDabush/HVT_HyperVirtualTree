...
class SharedNet_1(nn.Module):
    ...
    def __init__(self, hyper=False, multi_hyper=False, subcls=SubHyperDecisioNet, node_code: Tuple[int, ...] = ()):
        ...
        if self.hyper:
            ...
            self.after_features = nn.Sequential((nn.Conv2d(192, 192, 1, padding=0)), nn.ReLU(inplace=True),
...
class SmallFixedBasicHyperDecisioNet_1(nn.Module):
...
if __name__ == '__main__':
    ...
    model = SmallFixedBasicHyperDecisioNet_1()
