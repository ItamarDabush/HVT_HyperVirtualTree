...
from torchvision.datasets import CIFAR10, CIFAR100, ImageNet, ImageFolder, FashionMNIST, MNIST
...
DATA_ROOT_PATH = f'../data'  # change to the path where your data should be stored
